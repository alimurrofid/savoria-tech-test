...
<template>
  <div class="space-y-4">
    <div class="grid grid-cols-[1fr_auto_1fr] gap-4 items-stretch">
      ...
      <div class="flex flex-col border border-slate-200 rounded-xl overflow-hidden">
        ...
        <ul class="flex-1 overflow-y-auto divide-y divide-slate-50 min-h-48 max-h-72">
          ...
          >
            <div
              class="w-7 h-7 rounded-lg bg-slate-100 flex items-center justify-center text-slate-400 text-xs shrink-0 group-hover:bg-primary-50 group-hover:text-primary-500 transition-colors"
            >
            ...
            <i
              class="pi pi-angle-right text-slate-300 text-xs opacity-0 group-hover:opacity-100 transition-opacity"
            ></i>
          </li>
      ...
      <div class="flex flex-col border border-primary-200 rounded-xl overflow-hidden">
        <div
          class="px-4 py-2.5 bg-primary-50 border-b border-primary-100 flex items-center justify-between"
        >
        ...
        <ul class="flex-1 overflow-y-auto divide-y divide-slate-50 min-h-48 max-h-72">
          ...
          >
            <div
              class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-500 text-xs shrink-0 group-hover:bg-red-100 group-hover:text-red-500 transition-colors"
            >
              <i :class="app.icon ?? 'pi pi-th-large'"></i>
            </div>
            <div class="flex-1 min-w-0">
            ...
            <i
              class="pi pi-times text-slate-300 text-xs opacity-0 group-hover:opacity-100 group-hover:text-red-400 transition-opacity"
            ></i>
          </li>
    ...
    <div class="flex justify-end pt-2">
      <Button label="Save Access Rights" icon="pi pi-save" :loading="saving" @click="handleSave" />
    </div>
  </div>
</template>
